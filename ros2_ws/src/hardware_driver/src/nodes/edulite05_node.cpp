...
private:
  ...
  void retry_init_timer_callback()
  {
  ...
  void send_init_frames()
  {
    ...
    std::vector<Canframe> frames = motor_->create_init_frame();
    ...
    RCLCPP_INFO(this->get_logger(), "Published initialization frames for motor %d.", motor_id_);
  }
