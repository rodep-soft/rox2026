  ...
  void publish_field_markers()
  {
    ...
    // 8. 全27枚の公式 AprilTag (図面 2.3 & measurement.webp 実寸完全吸着)
    {
      ...
      const std::vector<TagData> all_tags = {
        ...
        {14, -3.640, -5.525, 1.000,  1.5708},
        {15, -3.230, -5.525, 1.000,  1.5708},
        {16, -2.820, -5.525, 1.000,  1.5708},
        {17, -3.640, -5.525, 0.590,  1.5708},
        {18, -3.230, -5.525, 0.590,  1.5708},
        {19, -2.820, -5.525, 0.590,  1.5708},
        {20, -3.640, -5.525, 0.180,  1.5708},
        {21, -3.230, -5.525, 0.180,  1.5708},
        {22, -2.820, -5.525, 0.180,  1.5708},

        // GAME2 3x3 シュートパネル (SIDE B 敵陣下側 X = +3.63m)
        {14,  3.220, -5.525, 1.000,  1.5708},
        {15,  3.630, -5.525, 1.000,  1.5708},
        {16,  4.040, -5.525, 1.000,  1.5708},
        {17,  3.220, -5.525, 0.590,  1.5708},
        {18,  3.630, -5.525, 0.590,  1.5708},
        {19,  4.040, -5.525, 0.590,  1.5708},
        {20,  3.220, -5.525, 0.180,  1.5708},
        {21,  3.630, -5.525, 0.180,  1.5708},
        {22,  4.040, -5.525, 0.180,  1.5708},
