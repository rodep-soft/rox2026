...
private:
  enum class State : uint8_t {IDLE, INTAKE, SHOOT, HOLD_SHOOT, RETURN_TO_DRIBBLE, MAX_OPEN};

  void declare_parameters();
  void get_parameters();
  void position_mode_callback(const std_msgs::msg::UInt8::SharedPtr msg);
  void intake_shoot_request_callback(const std_msgs::msg::Bool::SharedPtr msg);
  ...
  rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr intake_shoot_request_sub_;
