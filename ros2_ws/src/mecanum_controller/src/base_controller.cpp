...
private:
  ...
  void joy_callback(const sensor_msgs::msg::Joy::SharedPtr msg)
  {
    ...
    cmd_msg.linear.x = msg->axes[1] * max_linear_velocity_;  // 前後の移動;
    cmd_msg.linear.y = msg->axes[0] * max_linear_velocity_;  // 左右の移動;
    cmd_msg.angular.z = msg->axes[2] * angular_velocity_; // yawの回転
